 ...
 * Versions:
 *  ------	----------	-----------------
 *  3.0.7	2025-01-14  Add telnet as feature flag for websockets only use adds addiotnal security.
...
///// Telnet feature flag for websockets only use adds addiotnal security
#ifndef TELNET_ENABLED
#define TELNET_ENABLED true
#endif
...
void RemoteDebug::handle() {
	...
	if (TELNET_ENABLED && TelnetServer.hasClient()) {
